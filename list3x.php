...
<?php	
	$sTitle = "Pasien Lalu";
	$sColumns = "tanggal=Tanggal,nota=No.Nota,norm=No.RM,nama=Nama,alamat=Alamat,kelamin=Kelamin,umur=Umur,poli=Poli,tipe=Tipe,dokter=Dokter,sistembayar=Sistem Bayar,cetak=Cetak,kuncitrans=Kunci Transaksi";
	$sIndexColumn = "nota";
	$sHeaderDetail = false;	
	$sColsHeader = "";
	$sColsDetail = "";
	...
	and rs17.rs19='' and rs17.rs3<'".date("Y-m-d")."' and year(rs17.rs3)='".date("Y")."'
	...
	rs21.rs2 as dokter,
	rs17.rs8 as kd_poli,
	rs17.rs14 as kd_sistem_bayar 
	from rs51,rs17,rs21 where rs51.rs1=rs17.rs1 and rs51.rs8=rs21.rs1
	and rs51.rs3<'".date("Y-m-d")."' and year(rs51.rs3)>='2018' and rs51.rs20=''
	...
	rs23.rs19 as 
	kd_sistem_bayar 
	from rs51,rs23,rs21 where rs51.rs1=rs23.rs1 and rs51.rs8=rs21.rs1
	and rs51.rs3<'".date("Y-m-d")."' and year(rs51.rs3)>='2018' and rs51.rs20=''
	and (
		rs51.rs23='ME' 
		or rs51.rs23='FA' 
