...
<?php	
	...
	$sColsHeader = "";
	$sColsDetail = "";
	$sQuery = $conn->query("select kamar,tanggal,nota,norm,nama,alamat,
	kelamin,IF(thn<1,IF(bln<1,concat(hari,' hari'),concat(bln,' bln')),concat(thn,' thn')) as umur,
	poli,kunci,tipe,dokter,sistembayar,'' as cetak,'' as kuncitrans from(
	...
	select v_lab.*,rs15.rs2 as nama,rs15.rs4 as alamat,rs15.rs17 as kelamin, // PASIEN
	...
	rs19.rs2 as poli,rs9.rs2 as sistembayar,
	
	IF(rs15.rs31>1,'Lama','Baru') as tipe,'' as cetak from (
	
	
	select distinct rs51.rs2 as nota, 
	rs17.rs1 as noreg,'' as kamar,
	rs17.rs2 as norm,
	rs17.rs3 as kunjungan,
	rs51.rs3 as tanggal,
	rs51.rs18 as kunci,
	rs21.rs2 as dokter,
	rs17.rs8 as kd_poli,
	rs17.rs14 as kd_sistem_bayar from rs51,rs17,rs21 

	where rs51.rs1=rs17.rs1 and rs51.rs8=rs21.rs1    //RELASI KUNJUNGAN_POLI DAN TRANSAKSI LABORAT

	and year(rs51.rs3)='".date("Y")."' and month(rs51.rs3)='".date("m")."' and dayofmonth(rs51.rs3)='".date("d")."' and rs51.rs20=''
	...
	or rs51.rs23='POL032' or rs51.rs23='PEN005' or rs51.rs23='POL034' or rs51.rs23='POL035'
	or rs51.rs23='POL036' or rs51.rs23='POL037' or rs51.rs23='POL038' or rs51.rs23='POL039' or rs51.rs23='POL040')

	group by rs51.rs2 ) as v_lab,rs15,rs19,rs9 //GROUPBY


	where v_lab.norm=rs15.rs1 and v_lab.kd_poli=rs19.rs1 and v_lab.kd_sistem_bayar=rs9.rs1   //RELASI PASIEN, POLI , SISTEM BAYAR


	union all   //GABUNG QUERY
