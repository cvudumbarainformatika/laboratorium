...
<?php	
	$sTitle = "DATA PASIEN";
	$sColumns = "tanggal=Tanggal,nota=No.Nota,norm=No.RM,nama=Nama,alamat=Alamat,kelamin=Kelamin,umur=Umur,poli=Poli,tipe=Tipe,dokter=Dokter,sistembayar=Sistem Bayar";
	$sIndexColumn = "nota";
	$sHeaderDetail = false;	
	$sColsHeader = "";
	$sColsDetail = "";
	...
	poli,tipe,dokter,sistembayar from(
	...
	and rs17.rs19='1' and year(rs17.rs3)='".trim($_GET['tanggalx'])."' and month(rs17.rs3)='".trim($_GET['tanggal'])."' 
	...
	and rs51.rs20='2' and year(rs51.rs3)='".trim($_GET['tanggalx'])."' and month(rs51.rs3)='".trim($_GET['tanggal'])."'
