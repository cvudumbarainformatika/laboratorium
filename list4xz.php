...
<?php	
	...
	$sColumns = "tanggal=Tanggal,nota=No.Nota,norm=No.RM,nama=Nama,alamat=Alamat,telp=No.Telp.,kelamin=Kelamin,umur=Umur,poli=Poli,tipe=Tipe,dokter=Dokter,sistembayar=Sistem Bayar,cetak=Cetak,kuncitrans=Kunci Transaksi";
	$sIndexColumn = "nota";
	$sHeaderDetail = false;	
	$sColsHeader = "";
	$sColsDetail = "";
	$sQuery = $conn->query("select tanggal,nota,norm,nama,alamat,telp,kelamin,IF(thn<1,IF(bln<1,concat(hari,' hari'),concat(bln,' bln')),concat(thn,' thn')) as umur,
	poli,tipe,kunci,dokter,sistembayar,'' as cetak from(
	...
	rs17.rs2 as norm,rs17.rs14 as kd_akun,rs15.rs2 as nama,rs15.rs3 as sapaan,rs15.rs4 as alamat,rs15.rs55 AS telp,rs15.rs5 as kelurahan,
	...
	and rs17.rs19='1' and year(rs17.rs3)='".$_GET["thn"]."' and month(rs17.rs3)='".$_GET["bln"]."'
	and rs17.rs8='PEN002' group by rs17.rs1
	union all*/
	select v_lab.*,rs15.rs2 as nama,rs15.rs4 as alamat,rs15.rs55 AS telp,rs15.rs17 as kelamin,
	...
	select distinct rs51.rs2 as nota,rs17.rs1 as noreg,rs17.rs2 as norm,rs17.rs3 as kunjungan,rs51.rs3 as tanggal,rs51.rs18 as kunci,
	...
	and year(rs51.rs3)='".$_GET["thn"]."' and month(rs51.rs3)='".$_GET["bln"]."' and rs51.rs20='2'
	...
	select distinct rs51.rs2 as nota,rs23.rs1 as noreg,rs23.rs2 as norm,rs23.rs3 as kunjungan,rs51.rs3 as tanggal,rs51.rs18 as kunci,
