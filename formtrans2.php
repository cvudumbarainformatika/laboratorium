...
<table cellpadding="0" cellspacing="0" style="width:100%" border="0">
	...
	<tr class="header_pasien">
		...
		<td>&nbsp;<select name="sistembayar" tabindex="24" onkeypress="if(event.keyCode==13){ if(document.getElementById('sistembayar2').style.visibility=='hidden'){ document.frmdiagnosa.icd.focus(); }else{ document.form.sistembayar2.focus(); } }" onkeyup="getsistembayar();" onchange="getsistembayar();">
            <?php
	...
	<div id="tabs-6">
		...
		<table cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>&nbsp;<input type="text" name="tanggal_laborat" size="20" value="<?php echo date("d/m/Y H:i:s")?>" tabindex="14">&nbsp;</td>
			</tr>
			<tr valign="top">
			</tr>
			<tr valign="top">
