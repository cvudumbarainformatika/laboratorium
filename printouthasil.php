...
<?php	
	...
	poli,tipe,pengirim,sistembayar,'' as cetak,tanggalmasuk from(
	...
	while($rsx=$sqlx->fetch_object()){
		...
		$tanggalmasuk=$rsx->tanggalmasuk;
	}
	$tglx=explode(" ",$tanggalx);
?>		
<script type="text/javascript" src="../../html2pdf/html2pdf.bundle.js"></script>
<script type="text/javascript">document.onkeydown=function(event){pdfConvertFunc(event,document.body,'<?php echo str_replace("/","",$noreg)."_".$nama."_".$norm."_LAB"; ?>');}</script>
<table width="100%" cellpadding="0" cellspacing="0" border="0" bordercolor="#006699" bordercolordark="#666666" bordercolorlight="#003399">
	<tr>
		<td>&nbsp;TANGGAL&nbsp;</td>
		<td>&nbsp;:&nbsp;</td>
		<td>&nbsp;<?php echo $tglx[0];?>&nbsp;</td>
		<td>&nbsp;JAM PERMINTAAN :&nbsp;</td>
		<td>&nbsp;:&nbsp;</td>
		<td>&nbsp;<?php echo $tglx[1];?>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;NO. REG&nbsp;</td>
		<td>&nbsp;:&nbsp;</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bordercolor="#006699" bordercolordark="#666666" bordercolorlight="#003399">
	<tr valign="middle">
		...
		<td style="border-top:double #006699;border-bottom:1px solid #006699;height:30px;">&nbsp;TANGGAL&nbsp;</td>
		<td style="border-top:double #006699;border-bottom:1px solid #006699;height:30px;">&nbsp;JAM VALIDASI&nbsp;</td>
	</tr>
	<?php
	$x=0;
	$z=0;
	...
	rs51.rs5 as jml,((rs51.rs6+rs51.rs13)*rs51.rs5) as subtotal,rs51.rs21 as hasil,time(rs51.rs29) as tgl_hasil,date(rs51.rs29) as tgl_hasilz,rs49.rs22 as nilai from rs49,rs51 where rs49.rs1=rs51.rs4 and rs49.rs21=''
	and rs51.rs2='".trim($_GET['nota'])."'
	union all
	...
	((rs51.rs6+rs51.rs13)*rs51.rs5) as subtotal,rs51.rs21 as hasil,time(rs51.rs29) as tgl_hasil,date(rs51.rs29) as tgl_hasilz,rs49.rs22 as nilai from rs49,rs51 where rs49.rs1=rs51.rs4 and rs49.rs21<>''
	...
	<tr class="bodylist" valign="top">
		...
		<td>&nbsp;<?php echo $rs->tgl_hasilz;?>&nbsp;</td>
		<td>&nbsp;<?php echo $rs->tgl_hasil;?>&nbsp;</td>
	</tr>
	...
	<tr class="bodylist" valign="top">
		<td colspan="3">&nbsp;<?php echo $rs->keterangan;?>&nbsp;</td>
			...
			<?php			
				$sqlx=$conn->query("select rs51.rs4 as kode,rs49.rs2 as nama,rs51.rs21 as hasil,time(rs51.rs29) as tgl_hasil,date(rs51.rs29) as tgl_hasilz,rs49.rs22 as nilai from rs49,rs51 where rs49.rs1=rs51.rs4 
				...
				<tr>
					...
					<td>&nbsp;<?php echo $rsx->tgl_hasilz;?>&nbsp;</td>
					<td>&nbsp;<?php echo $rsx->tgl_hasil;?>&nbsp;</td>
				</tr>
	...
	<tr valign="middle">
		<td style="border-top:1px solid #006699;border-bottom:double #006699;height:30px;" colspan="5">
			<table width="100%"><td width="50%">&nbsp;JML PEMERIKSAAN : <?php echo $z;?>&nbsp;</td><td>&nbsp;&nbsp;</td></table>	
		</td>
	</tr>
</table>
